...
# import comfy_aimdo.control  <-- Disabled for AMD
...
def get_free_ram():
    ...
    #
    # 1: What psutil says
    # 2: Total Memory - Committed Memory
    #
    # We have removed the VRAM subtraction as comfy_aimdo is disabled.
    # This will still provide a safer calculation for AMD systems.
    ...
    # Fixed syntax error: removed the subtraction of aimdo vram
    return max(psutil.virtual_memory().available, total - committed)