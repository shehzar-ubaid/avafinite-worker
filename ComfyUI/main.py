...
# # import # comfy_aimdo.control  <-- Disabled for AMD compatibility

if enables_dynamic_vram():
    pass
    # # comfy_aimdo.control.init() <-- Disabled for AMD compatibility
    pass
...
# Disabled aimdo check for AMD/DirectML support
if enables_dynamic_vram() and comfy.model_management.is_nvidia() and not comfy.model_management.is_wsl():
    ...
    logging.info("DynamicVRAM check skipped for AMD/Manual setup.")
...
if __name__ == "__main__":
    ...
    # Check skipped for non-compatible packages
